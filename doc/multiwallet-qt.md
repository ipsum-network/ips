...
In order to support loading of multiple wallets in ips-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ips.cpp.
...
Changes to ips.cpp
----------------------
ips.cpp is the entry point into ips-qt, and as such, will require some minor modifications to provide hooks for
