...
The Ips project operates an open contributor model where anyone is
...
The following applies to code changes to the Ips project, and is not to be
confused with overall IPS Network Protocol consensus changes.

Whether a pull request is merged into Ips rests with the project merge
...
Patches that change IPS consensus rules are considerably more involved than
...
Where a patch set proposes to change the IPS consensus, it must have been
...
The project leader is the release manager for each Ips release.
